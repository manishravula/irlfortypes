...
try:
    ...
    config.SMSClient.messages.create(to=config.to_number,_from=config.from_number,body="All experiments finished succesfully")

except:
    config.SMSClient.messages.create(to=config.to_number,_from=config.from_number,body="Experiment exception! Check logs!")